...
joint-model alternative (Hodson et al. 2024), bootstrap coefficient
uncertainty, versioned ratings, and rating-amendment comparison.
...
`n_bounds`, and the `gauging_datetime` groundwork), see:
